...
var heart;
var happyPumpkin,happyPumpkin_Image;
var pumpkin,pumpkinImage;
var pumpkinGroup;
...
function preload() {
  ...
  pumpkinImage= loadImage("SCARY.jpg");
}

function setup() {
  createCanvas(900, 500);
  pumpkinImage=createSprite(300,400,30,20);
...
function spawnObstacles(){
  if (frameCount % 60 === 0){
    ...
    if (frameCount % 80 === 0){
      var obstacle = createSprite(830,430,10,10);
      obstacle.velocityX= -6;
